...
cd ios
xcodegen generate
open StrainEase.xcodeproj
```

Xcode 16+ / iOS 17+. Select the **StrainEase** scheme and an iPhone simulator.
...
`StrainEase.xcodeproj` is generated. Edit `project.yml`, then `xcodegen generate`. Don’t hand-edit the pbxproj.
